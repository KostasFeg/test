...
const ReportsPage: React.FC<ReportsPageProps> = ({ reportSlug }) => {
  ...
  const renderActions = () => {
    const actionType = getReportActionType(reportConfig?.slug || "");
  ...
  return (
    <div className="reports-page">
      <div className="reports-page__header">
        <h1 className="reports-page__title">{i18n.get(reportConfig.name)}</h1>
      </div>
